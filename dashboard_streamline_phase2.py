...
<div class="incident-age"><strong>{_age_text(r["created_at"])}</strong><span>Open</span></div></a>'''
    ...
    body = f'''{notice}<div class="overview-head"><div><h2>{base.esc(guild_info['name'])}</h2><div class="muted">Live rescue operations overview</div></div><div class="overview-actions"></div></div>
